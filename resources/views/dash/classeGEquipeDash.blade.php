...
<div class="col-lg-12 grid-margin stretch-card">
      ...
      <div class="card">
        <div class="card-body">
            ...
            <br>
          <h4 class="card-title">Classement Equipes Toutes Catégories</h4>
  ...
  @foreach ($classeG as $pt)
    ...
    <tr>
    <td>{{ $pt->nom_equipe }}</td>
      <td><a href="{{ route('classementDetailEquipe.dash',['id_equipe'=>$pt->id_equipe]) }}">
      ...
      <td><a href="{{ route('classementDetailEquipeEtape.dash',['id_equipe'=>$pt->id_equipe]) }}">Details par étapes</a>
    </tr>
    @endforeach
    ...
    <a href="{{ route('equipe.certificat') }}"  class="btn btn-success btn-lg">PDF</a>
